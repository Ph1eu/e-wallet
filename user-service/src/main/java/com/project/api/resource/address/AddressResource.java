...
public interface AddressResource {
    ...
    @GetMapping("")
    ResponseEntityWrapper<PageAddressRespondDto> list(@PathVariable String userid, @NotNull@Valid@BeanParam AddressFilterRequestDto addressFilterRequestDto);
    @PostMapping("")
    ...
    @PutMapping("/{id}")
    ResponseEntityWrapper<AddressResourceDto> update(@PathVariable String id,@RequestBody AddressUpdateRequestDto addressUpdateRequestDto, @PathVariable String userid);
    @DeleteMapping("/{id}")
